...
import { DataCarProps, dataCarController } from './dataCarController'
...
export function DataCar({ car }: DataCarProps) {
  const { handleSendMessage } = dataCarController({ car })
  return (
        ...
        <section className="w-2/2 h-full text-gray-700 mt-5 p-4 rounded-md border border-gray-500 ">
          ...
          <div className="w-full">
            <Button
              ...
              className="w-full bg-orange-700 hover:bg-orange-800">Entre em contato</Button>
          </div>
        </section>
